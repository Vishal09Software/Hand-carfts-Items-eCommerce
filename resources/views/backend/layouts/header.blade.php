...
<!-- Mirrored from themes.pixelstrap.com/fastkart/back-end/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jul 2023 09:08:26 GMT -->
<head>
    ...
    <!-- remixicon css -->
    <link rel="stylesheet" type="text/css" href="{{ url('backend/assets/css/remixicon.css') }}">
    ...
    <!-- Slick Slider Css -->
    <link rel="stylesheet" href="{{ url('backend/assets/css/vendors/slick.css') }}">
                ...
                <div class="header-logo-wrapper p-0">
                    <div class="logo-wrapper">
                        <a href="{{'/admin/dashboard'}}">
                            <img class="img-fluid main-logo" src="{{ url('backend/assets/images/logo/1.png') }}" alt="logo">
                            <img class="img-fluid white-logo" src="{{ url('backend/assets/images/logo/1-white.png') }}" alt="logo">
                        </a>
                    </div>
                    <div class="toggle-sidebar">
                        <i class="status_toggle middle sidebar-toggle" data-feather="align-center"></i>
                        <a href="{{'/admin/dashboard'}}">
                            <img src="{{ url('backend/assets/images/logo/1.png') }}" class="img-fluid" alt="">
                        </a>
                    </div>
                </div>
                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="profile-nav onhover-dropdown pe-0 me-0">
                            <div class="media profile-media">
                                <img class="user-profile rounded-circle" src="{{ url('backend/assets/images/users/4.jpg') }}" alt="">
            ...
            <div class="sidebar-wrapper">
                ...
                <div>
                    <div class="logo-wrapper logo-wrapper-center">
                        <a href="{{'admin/dashboard'}}" data-bs-original-title="" title="">
                            <img class="img-fluid for-white" src="{{ url('backend/assets/images/logo/full-white.png') }}" alt="logo">
                        </a>
                        <div class="back-btn">
                    ...
                    <div class="logo-icon-wrapper">
                        <a href="index.html">
                            <img class="img-fluid main-logo main-white" src="{{ url('backend/assets/images/logo/logo.png') }}" alt="logo">
                            <img class="img-fluid main-logo main-dark" src="{{ url('backend/assets/images/logo/logo-white.png') }}"
                                alt="logo">
                        </a>
                    </div>
                            ...
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        ...
                                        <li>
                                            <a href="{{'/admin/about/add'}}">About</a>
                                        </li>

                                        <li>
                                            <a href="{{'/admin/testimonial/add'}}">Reviews</a>
                                        </li>

                                        <li>
                                            <a href="{{'/admin/shipping_policy/add'}}">Shipping Policy</a>
                                        </li>

                                        <li>
                                            <a href="{{'/admin/privacy_policy/add'}}">Privacy Policy</a>
                                        </li>

                                        <li>
                                            <a href="{{'/admin/terms_&_condition/add'}}">Terms & Conditions</a>
                                        </li>
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        ...
                                        {{-- <li>
                                            <a href="{{'/subcategory/add'}}">Add New Subcategory</a>
                                        </li> --}}

                                        <li>
                                            <a href="{{'/admin/product/add'}}">Add New Product</a>
                                        </li>
                                    </ul>
                                </li>

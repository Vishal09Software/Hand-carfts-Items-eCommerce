                        ...
                        <div class="col-sm-8 m-auto">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ '/testimonial/add/update/' .$edit->id }}" method="Post"
                                        enctype="multipart/form-data" class="theme-form theme-form-2 mega-form">
                                        @csrf
                                        @method('PUT')
                                        <div class="mb-4 row align-items-center">
                                            <label class="form-label-title col-sm-3 mb-0">Reviewer Name</label>
                                            <div class="col-sm-9">
                                                <input id="my-input" class="form-control" type="text" name="rname"
                                                    placeholder="Enter Reviewer Name..."  value="{{ $edit->rname }}">
                                            </div>
                                        </div>

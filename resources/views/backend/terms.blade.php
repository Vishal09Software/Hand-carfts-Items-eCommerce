                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-header-2">
                                        <h5>Terms & condition  Information</h5>
                                    </div>
                                    @if (session('status'))
                                    ...
                                    <form action="{{ route('terms_&_condition.store') }}" method="Post"
                    ...
                    <div>
                        <table class="table all-package theme-table" id="table_id">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $data->id }}</td>
                                    <td>{!! Str::limit(strip_tags($data->desc), $limit = 30, $end = '...') !!}</td>
                                    <td>
                                        <ul>
                                            <li>
                                                <a href="{{'/terms_&_condition/add/edit/' . $data->id}}">
                                                    <i class="ri-pencil-line"></i>
                                                </a>
                                            </li>

                                            <li>
                                                <a href="{{'/terms_&_condition/add/delete/' . $data->id}}" >
